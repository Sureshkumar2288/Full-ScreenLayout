...
/*! splitbutton theme */
.e-split-btn-wrapper .e-split-btn {
  border-right-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
.e-split-btn-wrapper .e-split-btn:focus {
  border-right-color: #beb2d3;
}
.e-split-btn-wrapper .e-split-btn:active {
  border-right-color: linear-gradient(0deg, rgba(230, 225, 229, 0.12), rgba(230, 225, 229, 0.12)), linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
.e-split-btn-wrapper .e-split-btn:disabled {
  border-right-color: rgba(204, 194, 220, 0.12);
}
...
.e-split-btn-wrapper.e-rtl .e-split-btn {
  border-left-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
  border-right-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
.e-split-btn-wrapper.e-rtl .e-split-btn:focus {
  border-left-color: #beb2d3;
  border-right-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
.e-split-btn-wrapper.e-rtl .e-split-btn:active {
  border-left-color: linear-gradient(0deg, rgba(230, 225, 229, 0.12), rgba(230, 225, 229, 0.12)), linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
  border-right-color: linear-gradient(0deg, rgba(230, 225, 229, 0.12), rgba(230, 225, 229, 0.12)), linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
.e-split-btn-wrapper.e-rtl .e-split-btn:disabled {
  border-left-color: rgba(204, 194, 220, 0.12);
  border-right-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
...
.e-split-btn-wrapper.e-vertical .e-split-btn {
  border-bottom-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
  border-right-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
...
.e-split-btn-wrapper.e-vertical .e-split-btn:focus {
  border-bottom-color: #beb2d3;
  border-right-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
.e-split-btn-wrapper.e-vertical .e-split-btn:active {
  border-bottom-color: linear-gradient(0deg, rgba(230, 225, 229, 0.12), rgba(230, 225, 229, 0.12)), linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
  border-right-color: linear-gradient(0deg, rgba(230, 225, 229, 0.12), rgba(230, 225, 229, 0.12)), linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
.e-split-btn-wrapper.e-vertical .e-split-btn:disabled {
  border-bottom-color: rgba(204, 194, 220, 0.12);
  border-right-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
