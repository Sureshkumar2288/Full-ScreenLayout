...
.e-dropdown-popup ul .e-item:active, .e-dropdown-popup ul .e-item.e-selected {
  background-color: rgba(28, 27, 31, 0.06);
  color: #1c1b1f;
}
...
.e-split-btn-wrapper .e-split-btn:focus {
  border-right-color: #565063;
}
.e-split-btn-wrapper .e-split-btn:active {
  border-right-color: linear-gradient(0deg, rgba(28, 27, 31, 0.12), rgba(28, 27, 31, 0.12)), #ffffff;
}
.e-split-btn-wrapper .e-split-btn:disabled {
  border-right-color: rgba(98, 91, 113, 0.12);
}
...
.e-split-btn-wrapper.e-rtl .e-split-btn:focus {
  border-left-color: #565063;
  border-right-color: #ffffff;
}
.e-split-btn-wrapper.e-rtl .e-split-btn:active {
  border-left-color: linear-gradient(0deg, rgba(28, 27, 31, 0.12), rgba(28, 27, 31, 0.12)), #ffffff;
  border-right-color: linear-gradient(0deg, rgba(28, 27, 31, 0.12), rgba(28, 27, 31, 0.12)), #ffffff;
}
.e-split-btn-wrapper.e-rtl .e-split-btn:disabled {
  border-left-color: rgba(98, 91, 113, 0.12);
  border-right-color: #ffffff;
}
...
.e-split-btn-wrapper.e-vertical .e-split-btn:focus {
  border-bottom-color: #565063;
  border-right-color: #ffffff;
}
.e-split-btn-wrapper.e-vertical .e-split-btn:active {
  border-bottom-color: linear-gradient(0deg, rgba(28, 27, 31, 0.12), rgba(28, 27, 31, 0.12)), #ffffff;
  border-right-color: linear-gradient(0deg, rgba(28, 27, 31, 0.12), rgba(28, 27, 31, 0.12)), #ffffff;
}
.e-split-btn-wrapper.e-vertical .e-split-btn:disabled {
  border-bottom-color: rgba(98, 91, 113, 0.12);
  border-right-color: #ffffff;
}
...
*.e-flat.e-success .e-progress {
  background: rgba(32, 81, 7, 0);
}
*.e-flat.e-info .e-progress {
  background: rgba(1, 87, 155, 0);
}
*.e-flat.e-warning .e-progress {
  background: rgba(145, 76, 0, 0);
}
