...
.e-btn:hover,
.e-css.e-btn:hover {
  background: linear-gradient(0deg, rgba(28, 27, 31, 0.08), rgba(28, 27, 31, 0.08)), #ffffff;
  border-color: #ffffff;
  box-shadow: 0 2px 6px 2px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
  color: #1c1b1f;
}
...
.e-btn:active,
.e-css.e-btn:active {
  background: linear-gradient(0deg, rgba(28, 27, 31, 0.12), rgba(28, 27, 31, 0.12)), #ffffff;
  border-color: #ffffff;
  color: #1c1b1f;
  outline: #ffffff 0 solid;
  outline-offset: 0;
...
.e-css.e-btn:disabled {
  ...
  border-color: rgba(98, 91, 113, 0.12);
  box-shadow: none;
...
.e-css.e-btn.e-primary:hover {
  background: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #6750a4;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #6750a4;
  box-shadow: none;
  color: #ffffff;
}
...
.e-css.e-btn.e-primary:active {
  background: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #6750a4;
  border-color: #6750a4;
  color: #ffffff;
  outline: #ffffff 0 solid;
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
...
.e-css.e-btn.e-success:hover {
  background: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #205107;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #205107;
  box-shadow: none;
  color: #fff;
}
...
.e-css.e-btn.e-success.e-active {
  background: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #205107;
  border-color: #205107;
  color: #fff;
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
}
...
.e-css.e-btn.e-info:hover {
  background: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #01579b;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #01579b;
  box-shadow: none;
  color: #fff;
}
.e-btn.e-info:focus,
...
.e-css.e-btn.e-info.e-active {
  background: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #01579b;
  color: #fff;
  border-color: #01579b;
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
}
...
.e-css.e-btn.e-warning:hover {
  background: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #914c00;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #914c00;
  box-shadow: none;
  color: #fff;
}
...
.e-css.e-btn.e-danger:hover {
  background: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #b3261e;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #b3261e;
  box-shadow: none;
  color: #fff;
}
...
.e-css.e-btn.e-danger:active {
  background: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #b3261e;
  border-color: #b3261e;
  color: #fff;
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
}
...
.e-css.e-checkbox-wrapper .e-checkbox:focus + .e-frame {
  background-color: transparent;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #6750a4;
  box-shadow: none;
}
...
.e-css.e-checkbox-wrapper.e-checkbox-disabled .e-frame {
  background-color: transparent;
  border: 2px solid rgba(28, 27, 31, 0.38);
  color: rgba(28, 27, 31, 0.38);
}
.e-checkbox-wrapper.e-checkbox-disabled .e-frame.e-check,
.e-css.e-checkbox-wrapper.e-checkbox-disabled .e-frame.e-check {
  background-color: rgba(28, 27, 31, 0.38);
  border: none;
  border-color: rgba(28, 27, 31, 0.38);
  line-height: 14px;
  color: #ffffff;
}
...
.e-css.e-switch-wrapper .e-ripple-element {
  background-color: rgba(73, 69, 78, 0.12);
}
...
.e-css.e-switch-wrapper.e-switch-disabled .e-switch-handle {
  background-color: rgba(73, 69, 78, 0.38);
  box-shadow: none;
}
...
.e-css.e-switch-wrapper.e-switch-disabled .e-switch-inner .e-switch-off {
  opacity: 1;
  background-color: linear-gradient(0deg, rgba(103, 80, 164, 0.05), rgba(103, 80, 164, 0.05)), #ffffff;
...
.e-css.e-switch-wrapper:hover .e-switch-inner {
  background-color: linear-gradient(0deg, rgba(103, 80, 164, 0.11), rgba(103, 80, 164, 0.11)), #ffffff;
  border-color: #79747e;
}
...
.e-css.e-switch-wrapper:focus .e-switch-inner {
  background-color: #ffffff;
  border-color: linear-gradient(0deg, rgba(103, 80, 164, 0.11), rgba(103, 80, 164, 0.11)), #ffffff;
  box-shadow: none;
  outline: none;
...
.e-chip-list.e-chip.e-focused.e-active .e-chip-avatar, .e-chip-list .e-chip.e-focused.e-active .e-chip-avatar {
  background-color: linear-gradient(0deg, rgba(103, 80, 164, 0.12), rgba(103, 80, 164, 0.12)), #ffffff;
  color: #1c1b1f;
}
...
.e-chip-list.e-chip.e-disabled, .e-chip-list .e-chip.e-disabled {
  background-color: rgba(98, 91, 113, 0.12);
  border-color: rgba(98, 91, 113, 0.12);
  color: rgba(28, 27, 31, 0.38);
  opacity: 1;
  pointer-events: none;
...
.e-chip-list.e-chip.e-primary:hover, .e-chip-list .e-chip.e-primary:hover {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #6750a4;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #6750a4;
  color: #ffffff;
}
...
.e-chip-list.e-chip.e-primary.e-active, .e-chip-list .e-chip.e-primary.e-active {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #6750a4;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #6750a4;
  color: #ffffff;
}
...
.e-chip-list.e-chip.e-success:hover, .e-chip-list .e-chip.e-success:hover {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #205107;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #205107;
  color: #fff;
}
...
.e-chip-list.e-chip.e-success.e-focused, .e-chip-list .e-chip.e-success.e-focused {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #205107;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #205107;
  color: #fff;
}
...
.e-chip-list.e-chip.e-success.e-active, .e-chip-list .e-chip.e-success.e-active {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #205107;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #205107;
  color: #fff;
}
...
.e-chip-list.e-chip.e-success.e-outline:hover, .e-chip-list .e-chip.e-success.e-outline:hover {
  background-color: rgba(32, 81, 7, 0.08);
  border-color: #205107;
  color: #205107;
}
...
.e-chip-list.e-chip.e-success.e-outline.e-focused, .e-chip-list .e-chip.e-success.e-outline.e-focused {
  background-color: rgba(32, 81, 7, 0.12);
  border-color: #205107;
  color: #205107;
}
...
.e-chip-list.e-chip.e-success.e-outline.e-active, .e-chip-list .e-chip.e-success.e-outline.e-active {
  background-color: rgba(32, 81, 7, 0.16);
  border-color: #205107;
  color: #205107;
}
...
.e-chip-list.e-chip.e-info:hover, .e-chip-list .e-chip.e-info:hover {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #01579b;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #01579b;
  color: #fff;
}
...
.e-chip-list.e-chip.e-info.e-active, .e-chip-list .e-chip.e-info.e-active {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #01579b;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #01579b;
  color: #fff;
}
...
.e-chip-list.e-chip.e-info.e-outline.e-active, .e-chip-list .e-chip.e-info.e-outline.e-active {
  background-color: rgba(1, 87, 155, 0.16);
  border-color: #01579b;
  color: #01579b;
}
...
.e-chip-list.e-chip.e-warning:hover, .e-chip-list .e-chip.e-warning:hover {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #914c00;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #914c00;
  color: #fff;
}
...
.e-chip-list.e-chip.e-warning.e-outline:hover, .e-chip-list .e-chip.e-warning.e-outline:hover {
  background-color: rgba(145, 76, 0, 0.08);
  border-color: #914c00;
  color: #914c00;
}
...
.e-chip-list.e-chip.e-warning.e-outline.e-focused, .e-chip-list .e-chip.e-warning.e-outline.e-focused {
  background-color: rgba(145, 76, 0, 0.12);
  border-color: #914c00;
  color: #914c00;
}
...
.e-chip-list.e-chip.e-warning.e-outline.e-active, .e-chip-list .e-chip.e-warning.e-outline.e-active {
  background-color: rgba(145, 76, 0, 0.16);
  border-color: #914c00;
  color: #914c00;
}
...
.e-chip-list.e-chip.e-danger:hover, .e-chip-list .e-chip.e-danger:hover {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #b3261e;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #b3261e;
  color: #fff;
}
...
.e-chip-list.e-chip.e-danger.e-active, .e-chip-list .e-chip.e-danger.e-active {
  background-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #b3261e;
  border-color: linear-gradient(0deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.12)), #b3261e;
  color: #fff;
}
...
.e-chip-list.e-chip.e-danger.e-outline.e-active, .e-chip-list .e-chip.e-danger.e-outline.e-active {
  background-color: rgba(179, 38, 30, 0.16);
  border-color: #b3261e;
  color: #b3261e;
}
...
.e-speeddial-popup .e-speeddial-li .e-speeddial-li-icon {
  box-shadow: 0 3px 5px -1px rgba(0, 0, 0, 0.2), 0 6px 10px rgba(0, 0, 0, 0.14), 0 1px 18px rgba(0, 0, 0, 0.12);
  background: linear-gradient(0deg, rgba(103, 80, 164, 0.08), rgba(103, 80, 164, 0.08)), #ffffff;
  border-color: transparent;
}
...
.e-speeddial-popup .e-speeddial-li.e-disabled .e-speeddial-li-icon {
  background: linear-gradient(0deg, rgba(103, 80, 164, 0.08), rgba(103, 80, 164, 0.08)), #ffffff;
  border-color: linear-gradient(0deg, rgba(103, 80, 164, 0.08), rgba(103, 80, 164, 0.08)), #ffffff;
}
...
.e-speeddial-popup .e-speeddial-li:focus:not(.e-disabled) .e-speeddial-li-icon {
  background: linear-gradient(0deg, rgba(103, 80, 164, 0.08), rgba(103, 80, 164, 0.08)), #ffffff;
  border-color: linear-gradient(0deg, rgba(103, 80, 164, 0.08), rgba(103, 80, 164, 0.08)), #ffffff;
  box-shadow: 0 0 0 4px rgba(98, 91, 113, 0.5);
}
...
.e-speeddial-popup .e-speeddial-li:not(.e-disabled):hover .e-speeddial-li-icon {
  background: linear-gradient(0deg, rgba(103, 80, 164, 0.11), rgba(103, 80, 164, 0.11)), #ffffff;
  border-color: linear-gradient(0deg, rgba(103, 80, 164, 0.11), rgba(103, 80, 164, 0.11)), #ffffff;
}
...
.e-speeddial-popup .e-speeddial-li:not(.e-disabled):active .e-speeddial-li-icon {
  background: linear-gradient(0deg, rgba(103, 80, 164, 0.12), rgba(103, 80, 164, 0.12)), #ffffff;
  border-color: linear-gradient(0deg, rgba(103, 80, 164, 0.12), rgba(103, 80, 164, 0.12)), #ffffff;
}