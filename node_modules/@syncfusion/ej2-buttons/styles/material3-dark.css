...
.e-btn.e-small.e-round-edge,
.e-css.e-btn.e-small.e-round-edge {
  border-radius: 2px;
  padding: 4px 12px;
}
...
.e-small .e-btn.e-round-edge,
.e-small.e-btn.e-round-edge,
.e-small .e-css.e-btn.e-round-edge,
.e-small.e-css.e-btn.e-round-edge {
  border-radius: 2px;
  padding: 4px 12px;
}
...
.e-bigger.e-small .e-btn.e-round-edge,
.e-bigger.e-small .e-btn.e-round-edge,
.e-bigger.e-small .e-css.e-btn.e-round-edge,
.e-bigger.e-small.e-css.e-btn.e-round-edge {
  border-radius: 4px;
  padding: 8px 20px;
}
...
.e-bigger .e-btn.e-round-edge,
.e-bigger .e-btn.e-round-edge,
.e-bigger .e-css.e-btn.e-round-edge,
.e-bigger.e-css.e-btn.e-round-edge {
  border-radius: 4px;
  padding: 10px 24px;
}
...
.e-bigger .e-btn.e-small.e-round-edge,
.e-bigger .e-btn.e-small.e-round-edge,
.e-bigger .e-css.e-btn.e-small.e-round-edge,
.e-bigger.e-css.e-btn.e-small.e-round-edge {
  border-radius: 4px;
  padding: 8px 20px;
}
...
.e-css.e-btn {
  ...
  border-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
...
.e-btn:hover,
.e-css.e-btn:hover {
  background: linear-gradient(0deg, rgba(230, 225, 229, 0.08), rgba(230, 225, 229, 0.08)), linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
  border-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
  box-shadow: 0 2px 6px 2px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
  color: #e6e1e5;
}
...
.e-css.e-btn:focus {
  ...
  border-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
  color: #e6e1e5;
  outline: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f 0 solid;
  outline-offset: 0;
  box-shadow: 0 2px 6px 2px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
}
...
.e-btn:active,
.e-css.e-btn:active {
  background: linear-gradient(0deg, rgba(230, 225, 229, 0.12), rgba(230, 225, 229, 0.12)), linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
  border-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
  color: #e6e1e5;
  outline: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f 0 solid;
  outline-offset: 0;
...
.e-btn:disabled,
.e-css.e-btn:disabled {
  background: rgba(204, 194, 220, 0.12);
  border-color: rgba(204, 194, 220, 0.12);
  box-shadow: none;
...
.e-css.e-btn.e-primary:hover {
  background: linear-gradient(0deg, rgba(55, 30, 115, 0.08), rgba(55, 30, 115, 0.08)), #d0bcff;
  border-color: linear-gradient(0deg, rgba(55, 30, 115, 0.08), rgba(55, 30, 115, 0.08)), #d0bcff;
  box-shadow: none;
  color: #371e73;
}
...
.e-css.e-btn.e-primary:active {
  background: linear-gradient(0deg, rgba(55, 30, 115, 0.12), rgba(55, 30, 115, 0.12)), #d0bcff;
  border-color: #d0bcff;
  color: #371e73;
  outline: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f 0 solid;
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
...
.e-css.e-btn.e-success:hover {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #53ca17;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #53ca17;
  box-shadow: none;
  color: #000;
}
...
.e-css.e-btn.e-success.e-active {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #53ca17;
  border-color: #53ca17;
  color: #000;
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
}
...
.e-css.e-btn.e-info:hover {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #47acfb;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #47acfb;
  box-shadow: none;
  color: #000;
}
.e-btn.e-info:focus,
...
.e-css.e-btn.e-info.e-active {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #47acfb;
  color: #000;
  border-color: #47acfb;
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
}
...
.e-css.e-btn.e-warning:hover {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #f5b482;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #f5b482;
  box-shadow: none;
  color: #000;
}
...
.e-css.e-btn.e-danger:hover {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #f2b8b5;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #f2b8b5;
  box-shadow: none;
  color: #000;
}
...
.e-css.e-btn.e-danger:active {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #f2b8b5;
  border-color: #f2b8b5;
  color: #000;
  box-shadow: 0 1px 3px 1px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3);
}
...
.e-css.e-btn.e-flat.e-success:hover {
  background: rgba(83, 202, 23, 0.08);
  border-color: transparent;
  box-shadow: none;
  color: #53ca17;
}
...
.e-css.e-btn.e-flat.e-success:focus {
  background: rgba(83, 202, 23, 0.12);
  border-color: transparent;
  color: #53ca17;
  box-shadow: none;
}
...
.e-css.e-btn.e-flat.e-info:hover {
  background: rgba(71, 172, 251, 0.08);
  border-color: transparent;
  box-shadow: none;
  color: #47acfb;
}
...
.e-css.e-btn.e-flat.e-info:focus {
  background: rgba(71, 172, 251, 0.12);
  border-color: transparent;
  color: #47acfb;
  box-shadow: none;
}
...
.e-css.e-btn.e-flat.e-warning:hover {
  background: rgba(245, 180, 130, 0.08);
  border-color: transparent;
  box-shadow: none;
  color: #f5b482;
}
...
.e-css.e-btn.e-flat.e-warning:focus {
  background: rgba(245, 180, 130, 0.12);
  border-color: transparent;
  color: #f5b482;
  box-shadow: none;
}
...
.e-checkbox-wrapper:hover .e-ripple-element,
.e-css.e-checkbox-wrapper:hover .e-ripple-element {
  background: rgba(230, 225, 229, 0.08);
}
.e-checkbox-wrapper:hover .e-ripple-check .e-ripple-element,
.e-css.e-checkbox-wrapper:hover .e-ripple-check .e-ripple-element {
  background: rgba(208, 188, 255, 0.08);
}
...
.e-css.e-checkbox-wrapper .e-checkbox:focus + .e-frame {
  background-color: transparent;
  border-color: linear-gradient(0deg, rgba(55, 30, 115, 0.12), rgba(55, 30, 115, 0.12)), #d0bcff;
  box-shadow: none;
}
...
.e-css.e-checkbox-wrapper.e-checkbox-disabled .e-frame {
  background-color: transparent;
  border: 2px solid rgba(230, 225, 229, 0.38);
  color: rgba(230, 225, 229, 0.38);
}
.e-checkbox-wrapper.e-checkbox-disabled .e-frame.e-check,
.e-css.e-checkbox-wrapper.e-checkbox-disabled .e-frame.e-check {
  background-color: rgba(230, 225, 229, 0.38);
  border: none;
  border-color: rgba(230, 225, 229, 0.38);
  line-height: 14px;
  color: #371e73;
}
...
.e-css.e-switch-wrapper.e-switch-disabled .e-switch-handle {
  background-color: rgba(202, 196, 208, 0.38);
  box-shadow: none;
}
...
.e-css.e-switch-wrapper.e-switch-disabled .e-switch-inner .e-switch-off {
  opacity: 1;
  background-color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
...
.e-css.e-switch-wrapper:hover .e-switch-inner {
  background-color: linear-gradient(0deg, rgba(208, 188, 255, 0.11), rgba(208, 188, 255, 0.11)), #1c1b1f;
  border-color: #938f99;
}
...
.e-css.e-switch-wrapper:focus .e-switch-inner {
  background-color: #1c1b1f;
  border-color: linear-gradient(0deg, rgba(208, 188, 255, 0.11), rgba(208, 188, 255, 0.11)), #1c1b1f;
  box-shadow: none;
  outline: none;
...
.e-chip-list.e-chip:hover, .e-chip-list .e-chip:hover {
  background-color: rgba(230, 225, 229, 0.05);
  border-color: #938f99;
  color: #cac4d0;
}
...
.e-chip-list.e-chip.e-focused.e-active .e-chip-avatar, .e-chip-list .e-chip.e-focused.e-active .e-chip-avatar {
  background-color: linear-gradient(0deg, rgba(208, 188, 255, 0.12), rgba(208, 188, 255, 0.12)), #1c1b1f;
  color: #e6e1e5;
}
...
.e-chip-list.e-chip.e-disabled, .e-chip-list .e-chip.e-disabled {
  background-color: rgba(204, 194, 220, 0.12);
  border-color: rgba(204, 194, 220, 0.12);
  color: rgba(230, 225, 229, 0.38);
  opacity: 1;
  pointer-events: none;
...
.e-chip-list.e-chip.e-outline .e-chip-delete.e-dlt-btn, .e-chip-list .e-chip.e-outline .e-chip-delete.e-dlt-btn {
  color: linear-gradient(0deg, rgba(208, 188, 255, 0.05), rgba(208, 188, 255, 0.05)), #1c1b1f;
}
...
.e-chip-list.e-chip.e-primary:hover, .e-chip-list .e-chip.e-primary:hover {
  background-color: linear-gradient(0deg, rgba(55, 30, 115, 0.08), rgba(55, 30, 115, 0.08)), #d0bcff;
  border-color: linear-gradient(0deg, rgba(55, 30, 115, 0.08), rgba(55, 30, 115, 0.08)), #d0bcff;
  color: #371e73;
}
...
.e-chip-list.e-chip.e-primary.e-active, .e-chip-list .e-chip.e-primary.e-active {
  background-color: linear-gradient(0deg, rgba(55, 30, 115, 0.12), rgba(55, 30, 115, 0.12)), #d0bcff;
  border-color: linear-gradient(0deg, rgba(55, 30, 115, 0.12), rgba(55, 30, 115, 0.12)), #d0bcff;
  color: #371e73;
}
...
.e-chip-list.e-chip.e-success:hover, .e-chip-list .e-chip.e-success:hover {
  background-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #53ca17;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #53ca17;
  color: #000;
}
...
.e-chip-list.e-chip.e-success.e-focused, .e-chip-list .e-chip.e-success.e-focused {
  background-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #53ca17;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #53ca17;
  color: #000;
}
...
.e-chip-list.e-chip.e-success.e-active, .e-chip-list .e-chip.e-success.e-active {
  background-color: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #53ca17;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #53ca17;
  color: #000;
}
...
.e-chip-list.e-chip.e-success.e-outline:hover, .e-chip-list .e-chip.e-success.e-outline:hover {
  background-color: rgba(83, 202, 23, 0.08);
  border-color: #53ca17;
  color: #53ca17;
}
...
.e-chip-list.e-chip.e-success.e-outline.e-focused, .e-chip-list .e-chip.e-success.e-outline.e-focused {
  background-color: rgba(83, 202, 23, 0.12);
  border-color: #53ca17;
  color: #53ca17;
}
...
.e-chip-list.e-chip.e-success.e-outline.e-active, .e-chip-list .e-chip.e-success.e-outline.e-active {
  background-color: rgba(83, 202, 23, 0.16);
  border-color: #53ca17;
  color: #53ca17;
}
...
.e-chip-list.e-chip.e-info:hover, .e-chip-list .e-chip.e-info:hover {
  background-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #47acfb;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #47acfb;
  color: #000;
}
...
.e-chip-list.e-chip.e-info.e-active, .e-chip-list .e-chip.e-info.e-active {
  background-color: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #47acfb;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #47acfb;
  color: #000;
}
...
.e-chip-list.e-chip.e-info.e-outline:hover, .e-chip-list .e-chip.e-info.e-outline:hover {
  background-color: rgba(71, 172, 251, 0.08);
  border-color: #47acfb;
  color: #47acfb;
}
...
.e-chip-list.e-chip.e-info.e-outline.e-focused, .e-chip-list .e-chip.e-info.e-outline.e-focused {
  background-color: rgba(71, 172, 251, 0.12);
  border-color: #47acfb;
  color: #47acfb;
}
...
.e-chip-list.e-chip.e-info.e-outline.e-active, .e-chip-list .e-chip.e-info.e-outline.e-active {
  background-color: rgba(71, 172, 251, 0.16);
  border-color: #47acfb;
  color: #47acfb;
}
...
.e-chip-list.e-chip.e-warning:hover, .e-chip-list .e-chip.e-warning:hover {
  background-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #f5b482;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #f5b482;
  color: #000;
}
...
.e-chip-list.e-chip.e-warning.e-outline:hover, .e-chip-list .e-chip.e-warning.e-outline:hover {
  background-color: rgba(245, 180, 130, 0.08);
  border-color: #f5b482;
  color: #f5b482;
}
...
.e-chip-list.e-chip.e-warning.e-outline.e-focused, .e-chip-list .e-chip.e-warning.e-outline.e-focused {
  background-color: rgba(245, 180, 130, 0.12);
  border-color: #f5b482;
  color: #f5b482;
}
...
.e-chip-list.e-chip.e-warning.e-outline.e-active, .e-chip-list .e-chip.e-warning.e-outline.e-active {
  background-color: rgba(245, 180, 130, 0.16);
  border-color: #f5b482;
  color: #f5b482;
}
...
.e-chip-list.e-chip.e-danger:hover, .e-chip-list .e-chip.e-danger:hover {
  background-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #f2b8b5;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.08), rgba(0, 0, 0, 0.08)), #f2b8b5;
  color: #000;
}
...
.e-chip-list.e-chip.e-danger.e-active, .e-chip-list .e-chip.e-danger.e-active {
  background-color: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #f2b8b5;
  border-color: linear-gradient(0deg, rgba(0, 0, 0, 0.12), rgba(0, 0, 0, 0.12)), #f2b8b5;
  color: #000;
}
...
.e-chip-list.e-chip.e-danger.e-outline.e-active, .e-chip-list .e-chip.e-danger.e-outline.e-active {
  background-color: rgba(242, 184, 181, 0.16);
  border-color: #f2b8b5;
  color: #f2b8b5;
}
...
.e-speeddial-popup .e-speeddial-li.e-disabled .e-speeddial-li-icon {
  background: linear-gradient(0deg, rgba(208, 188, 255, 0.08), rgba(208, 188, 255, 0.08)), #1c1b1f;
  border-color: linear-gradient(0deg, rgba(208, 188, 255, 0.08), rgba(208, 188, 255, 0.08)), #1c1b1f;
}
...
.e-speeddial-popup .e-speeddial-li:focus:not(.e-disabled) .e-speeddial-li-icon {
  background: linear-gradient(0deg, rgba(208, 188, 255, 0.08), rgba(208, 188, 255, 0.08)), #1c1b1f;
  border-color: linear-gradient(0deg, rgba(208, 188, 255, 0.08), rgba(208, 188, 255, 0.08)), #1c1b1f;
  box-shadow: 0 0 0 4px rgba(204, 194, 220, 0.5);
}
...
.e-speeddial-popup .e-speeddial-li:not(.e-disabled):active .e-speeddial-li-icon {
  background: linear-gradient(0deg, rgba(208, 188, 255, 0.12), rgba(208, 188, 255, 0.12)), #1c1b1f;
  border-color: linear-gradient(0deg, rgba(208, 188, 255, 0.12), rgba(208, 188, 255, 0.12)), #1c1b1f;
}