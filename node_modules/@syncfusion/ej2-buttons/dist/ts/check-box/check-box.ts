...
export class CheckBox extends Component<HTMLInputElement> implements INotifyPropertyChanged {
    ...
    private clickHandler(event: Event): void {
        ...
        const changeEventArgs: ChangeEventArgs = { checked: this.updateVueArrayModel(false), event: event, isInteracted: this.clickTriggered };
        ...
        for (const prop of Object.keys(newProp)) {
            ...
            case 'checked':
                ...
                if (!this.isInteracted) {
                    const changeEventArgs: ChangeEventArgs = { checked: this.updateVueArrayModel(false), isInteracted: this.clickTriggered};
                    this.trigger('change',changeEventArgs);
                }
