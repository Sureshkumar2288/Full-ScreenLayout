...
let CheckBox = class CheckBox extends Component {
    ...
    clickHandler(event) {
        ...
        const changeEventArgs = { checked: this.updateVueArrayModel(false), event: event, isInteracted: this.clickTriggered };
            ...
            switch (prop) {
                case 'checked':
                    ...
                    if (!this.isInteracted) {
                        const changeEventArgs = { checked: this.updateVueArrayModel(false), isInteracted: this.clickTriggered };
                        this.trigger('change', changeEventArgs);
                    }
                    this.isInteracted = false;
                    break;
