 ...
 */
 gulp.task('dev-registry', function () {
    switchRegistry('https://nexus.syncfusion.com/repository/ej2-development/');
    npmrcConfig('//nexus.syncfusion.com/repository/ej2-development/');
});
...
gulp.task('release-registry', function () {
    switchRegistry('https://nexus.syncfusion.com/repository/ej2-release/');
...
gulp.task('hotfix-registry', function () {
    switchRegistry('https://nexus.syncfusion.com/repository/ej2-hotfix-new/');
    npmrcConfig('//nexus.syncfusion.com/repository/ej2-hotfix-new/');
});
...
var setNpmrc = function (branchName) {
    ...
    if (common.isRemoteServer) {
        ...
        registry = isHotfixBranch ? '//nexus.syncfusion.com/repository/ej2-hotfix-new/' : registry;
    } else {
