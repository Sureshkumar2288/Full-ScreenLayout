...
gulp.task('es-lint', function (done) {
    let output = shelljs.exec('npm run es-lint').stdout;
...
//     var file = fs.readFileSync('./node_modules/@syncfusion/ej2-build/.stylelintrc.json', 'utf8');
...
gulp.task('lint', ['dedupe', 'es-lint-config', 'es-lint', 'md-lint', 'html-lint']);