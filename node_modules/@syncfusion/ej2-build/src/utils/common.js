...
function clone(user, token, done, name, product) {
    ...
    var tempRepo = 'https://' + user + ':' + token + '@github.com/essential-studio/' + name;
    if(product === 'angular') {
        shelljs.exec(
            'git clone ' + tempRepo + ' -b ' + 'master' + ' ./third-party/' + product, {
                silent: false
            },
            function () {
        ...
        shelljs.exec(
            'git clone ' + tempRepo + '.git' + ' ./third-party/' + product, {
                silent: false
            },
            function () {
                console.log('Clone has been completed!');
