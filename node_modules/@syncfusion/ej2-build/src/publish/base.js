...
var themes = [];
/* jshint ignore:start */
var themes = ['material', 'fabric', 'bootstrap', 'highcontrast', 'bootstrap4', 'bootstrap5', 'fluent', 'tailwind', 'material-dark', 'fabric-dark', 'bootstrap-dark', 'bootstrap5-dark', 'tailwind-dark', 'fluent-dark' ];
/* jshint ignore:end */
 ...
 */
 gulp.task('es5-mapping', function () {
 ...
 */
gulp.task('publish', ['typings-mapping', 'npmignore', 'dev-registry', 'es5-mapping'], function (done) {
