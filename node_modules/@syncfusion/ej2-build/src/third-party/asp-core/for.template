...
#else
           string id = ForControl.GenerateIdFromName(ForControl.GetExpressionText(expression, factory).Name);           
#endif
            {{htmlAttrID}}
...
            }
            ...
            if (attrID != null && !string.IsNullOrEmpty(attrID))
            {
...
#else
            completeBuilder.inputText = ForControl.GetInputText(factory.htmlHelper.TextBoxFor(expression, HtmlAttr));
#endif
