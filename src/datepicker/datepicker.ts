...
import { detach, addClass, removeClass, closest, attributes, Touch, ScrollEventArgs, SwipeEventArgs } from '@syncfusion/ej2-base';
...
export class DatePicker extends Calendar implements IInput {
    ...
    protected isTouchstart: boolean;
    /**
     ...
     */
    @Property(false)
    public mobileFullScreenMode : boolean;
    /**
            ...
            open: () => {
                if (Browser.isDevice) {
                    this.touchModule = new Touch(<HTMLElement>this.calendarElement.querySelector(".e-content.e-month"), {
                        swipe: this.CalendarScrollHandler.bind(this)
                    });
    ...
    private CalendarScrollHandler(e: SwipeEventArgs): void {
        const count: number = e.swipeDirection === "Up" ? 1 : e.swipeDirection === "Down" ? -1 : 0;
